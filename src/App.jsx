...
function App() {
  ...
  return (
    <div className="app-container" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      {/* Top Banner */}
      <div className="top-banner" style={{ backgroundImage: activeTheme === 'sor' ? 'linear-gradient(90deg, rgba(220, 38, 38, 0) 0%, rgba(220, 38, 38, 0.8) 50%, rgba(220, 38, 38, 0) 100%)' : "url('/banner.png')", backgroundSize: '100% 100%', position: 'relative' }}>
        {activeTheme === 'sor' ? (
