      ...
      <div style={{ position: 'relative', zIndex: 10, display: 'flex', flexDirection: 'column', height: '100%', width: '100%' }}>
        ...
        <div className="main-content" style={showExplanationGenerator ? { padding: '16px', boxSizing: 'border-box' } : {}}>
          ...
          {isPortrait ? (
            ...
            <div className="main-content-layout" style={{ display: 'flex', flexDirection: 'row', flex: 1, width: 'calc(100% + 20px)', height: 'calc(100% + 20px)', margin: '-10px', minHeight: 0, overflow: 'hidden', position: 'relative' }}>
              <div className="stage-column" style={{ flex: 1, display: 'flex', minWidth: 0, height: '100%', padding: isChatOpen ? '10px 0 10px 10px' : '10px 10px 10px 10px', boxSizing: 'border-box', transition: 'all 0.32s ease' }}>
